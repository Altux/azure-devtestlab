<##################################################################################################
	...
	Set up NicePolitechnique template at the first start up

    Usage examples
    ==============

    PowerShell -ExecutionPolicy bypass ./NicePolitechnique-PostDeployment.ps1 
...
# supprimer internet explorer pin 
# ajouter Chrome pin 